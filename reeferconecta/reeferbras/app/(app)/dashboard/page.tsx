      ...
      <main className="min-h-screen px-4 py-8 text-slate-900 sm:px-6 sm:py-10">
        <section className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <section className="rounded-xl border border-slate-700 bg-slate-900/70 p-5 sm:p-6">
              <div className="flex items-start justify-between gap-4">
                <div><h2 className="text-xl font-semibold text-white">Reports por setor</h2><p className="mt-1 text-sm text-slate-400">Total: {totalReports} reports · Almoxarifado excluído</p></div>
